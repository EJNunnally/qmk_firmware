...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_QWERTY] = LAYOUT( // The right space is so I can see if I actually type faster
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,
                        KC_LALT, KC_LGUI, MO(_LOWER), KC_SPC,  KC_SPC, KC_BSPC, KC_ENT, MO(_RAISE)
),
...
[_LOWER] = LAYOUT( // I need the 3 key for Minecraft's F3 + 3 hotkey
  ...
  _______, XXXXXXX, XXXXXXX, KC_MINS,  KC_EQL, XXXXXXX,                   KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, XXXXXXX, XXXXXXX,
